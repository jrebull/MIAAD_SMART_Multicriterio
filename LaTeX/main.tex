...
\vspace{0.8cm}
{\large\itshape Práctica de Laboratorio de Optimización Inteligente\par}
...
\end{titlepage}
% titlepage reinicia el contador a 1; lo avanzamos para que el índice no
% reuse el ancla PDF "page.1" (warning de destinos duplicados en hyperref).
\setcounter{page}{2}
...
\input{sections/04_analisis_ponderada}
\input{sections/05_analisis_lexicografico}
\input{sections/06_conclusion_profesional}
